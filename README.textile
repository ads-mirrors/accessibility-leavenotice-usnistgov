...
This version of leaveNotice is forked from the original at http://github.com/rewdy/leaveNotice .  Minor changes have been made to facilitate its use at NIST, including placing everything in the nist-pages branch to allow all the files to be published on pages.nist.gov for easy linking into other projects, and updating the HTML to conform to NIST standards.
